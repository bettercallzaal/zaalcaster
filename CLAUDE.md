...
- Flagship roadmap (Zaal 2026-07-04): 1 cockpit TUI DONE (#14), 2 thread-context drafts DONE (full ancestor chain per item into voice.js prompt + cockpit thread view), 3 channel dedupe DONE (#12), 4 polish: cockpit --dry exists; NEXT - save Zaal's [e] edits as voice examples (~/.zao/private/zaal-voice-examples.md, never committed) fed into VOICE_PROMPT.
